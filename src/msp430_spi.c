...
void spi_init()
{
	...
	USICKCTL = USISSEL_2 | USIDIV_1;  // Clock source = SMCLK/2
...
void spi_init()
{
	...
	UCA0BR0 = 0x02;  // SPI clocked at SMCLK/2
	UCA0BR1 = 0x00;
...
void spi_init()
{
	...
	UCB0BR0 = 0x02;  // SPI clocked at SMCLK/2
	UCB0BR1 = 0x00;
